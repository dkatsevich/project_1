...
var forms = function forms() {
  function sendForm(formSelector, url) {
    ...
    form.addEventListener('submit', function (e) {
      ...
      Object(_services_services__WEBPACK_IMPORTED_MODULE_6__["postData"])(url, JSON.stringify(Object.fromEntries(formData.entries()))).then(function () {
        return messageBlock.textContent = statusMessage.sucsess;
      }).catch(function () {
        return messageBlock.textContent = statusMessage.faillure;
      }).finally(form.reset());
      setTimeout(function () {
        messageBlock.remove();
      }, 5000);
...
/*!*********************************!*\
  !*** ./src/js/modules/modal.js ***!
  \*********************************/
/*! exports provided: default, bindModal */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var numberValidation = function numberValidation() {
  var numberInputs = document.querySelectorAll('[data-number="valid"]');
...
/* harmony default export */ __webpack_exports__["default"] = (numberValidation);
    ...
    while (1) {
      switch (_context.prev = _context.next) {
        ...
        case 2:
          ...
          throw new Error("Response not posting, status - ".concat(res.status));
